# Now with Git! Now using a single script that handles automatic versioning!
# Test version to test script
...

{
  ...
  services.xserver.displayManager.autoLogin.user = "echo";
